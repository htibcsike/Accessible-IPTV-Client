...
Ha a Beállítások > Minimalizálás a rendszertálcára lehetőség engedélyezve van, a főablak bezárásakor vagy minimalizálásakor az alkalmazás nem lép ki, hanem az értesítési területen fut tovább. Így az ütemezett felvételek a háttérben is elindulhatnak és folytatódhatnak. A rendszertálca ikonjának aktiválásával újból megjelenítheti a főablakot. Az ikon helyi menüjében többek között az Ablak visszaállítása, a Lejátszó vezérlőelemei, folyamatban lévő rögzítés esetén a Rögzítések leállítása, valamint a Kilépés található. A menü Kilépés parancsa ugyanazt a megerősítő kérdést jeleníti meg, mint az ablak bezárásakor: név szerint felsorolja az összes indításra váró felvételt, mindegyiket a helyi idő szerinti ütemezett időpontjával együtt, így még megszakíthatja a kilépést, nehogy valamelyik rögzítés elmaradjon.
