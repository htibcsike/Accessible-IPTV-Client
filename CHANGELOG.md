...
- Complete accessible playback and recording controls (#4)

### Documentation

- Drop a machine-specific path from agents notes
...
- Build a macOS app with ffmpeg and VLC bundled

## v1.140.1 - 2026-09-23

### Documentation

- Add missing #22 Hungarian tray-exit paragraph to hu.md

## v1.140.0 - 2026-09-22

### Features

- Make formats follow stream media type
- Collapse older English releases behind a toggle (#28)

### Accessibility

- Name manager lists, repair What's on Now keys, select now-airing EPG row (#3)
...
- Add recording problem jump times and fix update handoff

## v1.138.4 - 2026-09-19

### Bug fixes

- The Applications key opens the scheduled-recording menu, not Alt
- File > Exit quits even when Minimize to System Tray is on

## v1.138.3 - 2026-09-19

### Bug fixes

- Close the window when the update is done, and stop pressing Alt

## v1.138.2 - 2026-09-19

### Bug fixes

- Keep the window heard, and confirm the update only once

## v1.138.1 - 2026-09-19

### Bug fixes

- Stop Restart Manager aborting the silent install (#31)
- Keep one window on screen for the whole update (#30)
...
- Run one copy of the app, so a reopened app cannot ruin a recording
...
- Keep the status window focused through the install (fixes #30)
...
- Say why an update failed and never leave a broken install (#26)

## v1.136.7 - 2026-09-18

### Bug fixes

- Show OK and Cancel in the app's language in every dialog (#29)

### Other changes

- Keep What's New translation commits out of the release notes (#27)
...
- Stop a release until every language except Hungarian is translated

## v1.136.4 - 2026-09-17

### Documentation

- Translate the latest help and release notes into every language except Hungarian
...
- Start the Windows updater reliably and report when it cannot (#26)

### Other changes

- I18n(hu): clearer restart wording in the update prompt (#26)

## v1.136.1 - 2026-09-16

### Bug fixes

- Never classify Breaking from commit body prose

### Other changes

- I18n(hu): finalize v1.136.0 release-note localization and help wording

## v1.136.0 - 2026-09-16

### Features

- Localize What's New release notes
...
- Protect scheduled recordings on exit

## v1.135.0 - 2026-09-12

- Add in-app What's New history and refine scheduled recording deletion
...
- Use the definite article in the Hungarian update-confirmation message
- Record catch-up truncation, padding and PO-filling learnings

## v1.134.0 - 2026-09-12

- Update confirmation, recording diagnostics, scheduler guidance, catch-up padding and truncation retries
- Ignore local agent scratch and the stray root update manifest

## v1.133.0 - 2026-09-12

- Translate the update helper's status window (#18)
- Proofread Hungarian user guide and interface wording (#17)
- Prefer exact channel name when scores tie (#16)
- Refresh catalogue source references

## v1.132.2 - 2026-09-11

- Close probe and redirect responses instead of leaking them
...
- Offline User Guide with context-sensitive F1 help (#14)
...
- Keep the chosen or described audio track

## v1.128.0 - 2026-09-11

- Name catch-up downloads for when the programme aired
...
- Apply the remembered audio track again by reading libVLC's state correctly
...
- Record from the built-in player, Schedule Recording on EPG rows, an optional stream-URL field, and fixes for update restarts, About links, catch-up Enter and forgotten playlist names

## v1.120.0 - 2026-09-07

- Inline download errors and automatic catch-up download retry
...
- Hourly update checks, fuzzy EPG row matching, next programme in rows, EPG dialog descriptions

## v1.118.0 - 2026-09-07

- Announce the on-air programme in each channel row; drop the EPG info field

## v1.117.0 - 2026-09-07

- Copy URL in the EPG and Playlist managers

## v1.116.0 - 2026-09-07

- Faster catch-up downloads, clearer download window, EPG descriptions, audio device picker
...
- Catchup templates, per-playlist All Channels, richer logs, audio-track memory

## v1.113.1 - 2026-09-06

- Accessible-playlist-controls

## v1.113.0 - 2026-09-06

- Improve accessible playback and recording

## v1.112.1 - 2026-09-05

- Restore Tab access to channel search and programme information

## v1.112.0 - 2026-09-05

- Name playlists and EPG sources and fix playlist navigation
- Document aborted-release recovery and drop the local memory block

## v1.111.1 - 2026-09-05

- Add a playlist scope picker before the categories list
...
- Keep Windows detection subprocess-free
- Record Windows test tooling quirks
- Upload-artifact v7 for the Node 24 runtime
- Clear the Node 20 deprecation warning and pin .po endings to LF
...
- Resync translation catalogues and pin chardet for the release build

## v1.106.0 - 2026-07-12

- Add 12 languages and keep catalogues synced on release
